package com.shinyleo.cms.action;
...
import com.shinyleo.proxy.util.Header;
import com.shinyleo.proxy.util.Proxy;
import com.shinyleo.proxy.util.Result;
...
public class GeneraterAction extends BaseAction {
    ...
    public void genernateForArticle(HttpServletResponse response, HttpServletRequest request, @PathVariable int columnId) {
        ...
        Header header = new Header(this.getHost(request), com.shinyleo.base.constant.Const.UTF8);
        String cookie = "";
