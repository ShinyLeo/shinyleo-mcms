package com.shinyleo.cms.parser;
...
import com.shinyleo.cms.parser.impl.*;
...
import com.shinyleo.mdiy.parser.ListParser;
import com.shinyleo.mdiy.parser.TaglibParser;
import com.shinyleo.parser.IParserRegexConstant;
import com.shinyleo.parser.PageUtilHtml;
import com.shinyleo.parser.impl.general.ChannelContParser;
import com.shinyleo.parser.impl.general.PageNumParser;
import com.shinyleo.parser.impl.general.PageParser;
    ...
    private String parseArclist() {
        ...
        for (int i = 0; i < listNum; i++) {
            ...
            if (articleCount != 0) {
                ...
                // 替换列表标签
                htmlContent = new com.shinyleo.cms.parser.impl.ListParser(app,htmlContent, listArticles,  this.getWebsiteUrl(), property, false, fieldBiz, contentBiz).parse();
            }else{
                htmlContent = new com.shinyleo.cms.parser.impl.ListParser(app,htmlContent, null,  this.getWebsiteUrl(), property, false, fieldBiz, contentBiz).parse();
            }
        }
        return htmlContent;
    }
        ...
        if (isPaging != null && isPaging.equals("true")) {
            ...
            if (column!=null) {
                ...
                if (articleCount != 0) {
                    ...
                    // 替换列表标签
                    htmlContent = new com.shinyleo.cms.parser.impl.ListParser(app,htmlContent, listArticles,  this.getWebsiteUrl(), property, true, fieldBiz, contentBiz).parse();
                }else{
                    htmlContent = new com.shinyleo.cms.parser.impl.ListParser(app,htmlContent, null,  this.getWebsiteUrl(), property, true, fieldBiz, contentBiz).parse();
                }
            }
        }
        return htmlContent;
