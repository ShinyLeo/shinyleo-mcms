<@ms.html5>
	...
	<@ms.panel>
				...
				<@ms.table head=["<th class='text-center'>编号</th>",'文章标题,150','栏目名,150','缩略图,150','作者,90','<th class="text-center">点击量</th>','<th class="text-center">排序</th>'] checkbox="ids">
					<#if listArticle?has_content>
			        	<#list listArticle as listArticle>
		                	<tr id="tableArticle">
					            ...
					            <td>${listArticle.basicThumbnails?default("")}</td>
