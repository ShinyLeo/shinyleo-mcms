...
<#include "${managerViewPath}/include/meta.ftl"/>
    ...
    <link rel="stylesheet" type="text/css" href="${static}/skin/manager/4.5.5/css/login.css" media="all" />
    <link rel="stylesheet" type="text/css" href="${static}/skin/manager/4.5.5/css/reset.css">
    <link rel="stylesheet" type="text/css" href="${static}/skin/manager/4.5.5/css/supersized.css">
    <link rel="stylesheet" type="text/css" href="${static}/skin/manager/4.5.5/css/style.css">
    <script type="text/javascript" src="${static}/skin/manager/4.5.5/js/supersized.3.2.7.min.js"></script>
    <script type="text/javascript" src="${static}/skin/manager/4.5.5/js/supersized-init.js"></script>
    <script type="text/javascript" src="${static}/skin/manager/4.5.5/js/scripts.js"></script>
    <script>
