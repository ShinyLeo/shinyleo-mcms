...
public class PageUtil {
    ...
    public String getIndexUrl() {
        if(this.pageNo == 0) {
            ...
            this.indexUrl = this.linkUrl + (this.hasParams?"&":"?") + "pageNo=1";
        }
    ...
    public String getPreviousUrl() {
        if(this.pageNo == 0) {
            ...
            this.previousUrl = this.linkUrl + (this.hasParams?"&":"?") + "pageNo=" + this.pageNo;
        }
    ...
    public String getNextUrl() {
        if(this.pageNo == this.pageCount) {
            ...
            this.nextUrl = this.linkUrl + (this.hasParams?"&":"?") + "pageNo=" + this.pageCount;
        } else {
            this.nextUrl = this.linkUrl + (this.hasParams?"&":"?") + "pageNo=" + (this.pageNo + 2);
        }
    ...
    public String getLastUrl() {
        if(this.pageNo == this.pageCount) {
            ...
            this.lastUrl = this.linkUrl + (this.hasParams?"&":"?") + "pageNo=" + this.pageCount;
        }
    ...
    public String getLinkUrl() {
        return this.linkUrl + (this.hasParams?"&":"?");
    }
