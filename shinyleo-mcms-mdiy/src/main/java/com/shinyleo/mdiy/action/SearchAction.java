...
public class SearchAction extends BaseAction {
	...
	public String generateSreachFormHtml(ModelMap model, HttpServletRequest request) {
		...
		int cmId = 0;
		Map<String, String> basicField = getMapByProperties(com.shinyleo.mdiy.constant.Const.BASIC_FIELD);
		Map<String, String> basicAttribute = getMapByProperties(com.shinyleo.mdiy.constant.Const.BASIC_ATTRIBUTE);
